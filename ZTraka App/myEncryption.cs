...
namespace ZTraka_App
{
    ...
    /// <summary>
    /// Encryption class to handle password encryptions
    /// </summary>
    public class myEncryption
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="myEncryption" /> class.
        /// </summary>
        public myEncryption()
        { 
        ...
        public static string Encrypt(string toEncrypt, bool useHashing)
        {
            ...
            // Get the key from seetings file

            string key = Properties.Settings.Default.SecurityKey.ToString();
